-- =============================================
-- Script: Triggers de Auditoría para TAREA
-- Base de datos: HERMES
-- Descripción: Triggers automáticos para capturar INSERT, UPDATE, DELETE de tareas
-- =============================================
    ...
    SELECT
        ...
        (SELECT
            (SELECT
                ...
                permite_entrega_con_retraso
             FROM deleted d WHERE d.id_tarea = i.id_tarea FOR JSON PATH, WITHOUT_ARRAY_WRAPPER) AS Anterior,
            (SELECT
                id_tarea,
                usuario_emisor_id,
                usuario_receptor_id,
                ...
                fecha_completada_tarea,
                permite_entrega_con_retraso
             FROM inserted i2 WHERE i2.id_tarea = i.id_tarea FOR JSON PATH, WITHOUT_ARRAY_WRAPPER) AS Nuevo
...
PRINT 'Triggers de auditoría para TAREA creados exitosamente';
