...
-- Agregar campo id_usuario_subio a TAREA_ADJUNTO (si no existe)
ALTER TABLE TAREA_ADJUNTO 
ADD id_usuario_subio UNIQUEIDENTIFIER NULL;

-- Agregar foreign key
ALTER TABLE TAREA_ADJUNTO
ADD CONSTRAINT FK_ADJUNTO_USUARIO 
FOREIGN KEY (id_usuario_subio) REFERENCES USUARIO(id_usuario);
